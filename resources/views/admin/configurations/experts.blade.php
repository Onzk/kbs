<div class="main-content container-fluid">
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3 class="text-primary">Experts KAPI</h3>
                <p class="text-subtitle text-muted">
                    Voici la liste de tous les experts KAPI visibles sur le site vitrine.
                </p>
            </div>
        </div>
    </div>
            ...
            <div class="card-header px-2 py-3 w-100 text-right bg-primary">
                <div class="row p-0 justify-content-between align-items-center">
                    <div class="col-md-6 text-left">
                        <span class="text-sm px-2 text-white">Experts KAPI</span>
                    </div>
    ...
    @include('admin.modals.expert-form-modal')
