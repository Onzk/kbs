                    ...
                    <div class="row">
                        <div class="col-md-12 col-12">
                            <div class="form-group">
                                ...
                                <input id="title" type="text" required min="2"
                                    wire:model="model_form.title" placeholder="{{ __('Titre') }}"
                                    class="form-control">
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input id="datetime" type="datetime-local" required min="2"
                                    wire:model="model_form.datetime" placeholder="{{ __('Date') }}"
                                    class="form-control">
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                <label for="url">
                                    {{ __("Lien d'inscription") }}
                                </label>
                                <input id="url" type="url" required min="2" wire:model="model_form.url"
                                    placeholder="{{ __("Lien d'inscription") }}" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 col-12">
                            <div class="form-group">
                                ...
                                <textarea id="description" type="text" required min="2" maxlength="255" rows="6"
