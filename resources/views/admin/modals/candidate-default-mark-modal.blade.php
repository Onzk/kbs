<div class="modal fade text-left" id="setDefaultMR" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33"
        ...
        <div wire:loading.remove wire:target="current_id" @class([
            ...
            <div class="modal-header bg-white">
                <h4 class="modal-title text-dark" id="myModalLabel33">
                    {{ __('Formulaire de notation par défaut') }}
                </h4>
            ...
            <form wire:submit="setDefaultMark">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" rows="6" minlength="8" maxlength="255" required class="form-control"
                            wire:model="state.default_comment" placeholder="{{ __('Donnez votre avis sur la qualité du candidat . . .') }}"></textarea>
                    </div>
                </div>
                <div class="modal-footer">
                    <div wire:loading wire:target="setDefaultMark" class="btn" disabled style="pointer-events: none">
                        <div class="spinner-border spinner-border-sm text-primary" role="status"></div>
                    </div>
                    <div wire:loading.remove wire:target="setDefaultMark">
                        <button type="submit" wire:click="setDefaultMark" class="btn btn-warning ml-1"
                            data-dismiss="modal">
