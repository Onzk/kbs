                    ...
                    <div class="row">
                        <div class="col-md-12 col-12">
                            <div class="form-group">
                                ...
                                <input id="question" type="text" min="2" wire:model="model_form.question"
                                    placeholder="{{ __('Question') }}" required class="form-control">
                            </div>
                        </div>
                        <div class="col-md-12 col-12">
                            <div class="form-group">
                                ...
                                <textarea id="answer" type="text" min="2" rows="6" wire:model="model_form.answer"
