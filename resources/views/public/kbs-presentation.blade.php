...
@section('public.base.body')
    ...
    <div class="container-fluid hero-header mb-5 px-0"
        style="background: url('{{ asset('assets/public/img/hero-1.png') }}') no-repeat center;">
        <div class="py-5 col" style="background-color: rgba(0, 0, 0, 0.50)">
            <div class="container py-5 col d-flex align-items-center justify-content-center" style="min-height: 700px;">
                <div class="col-md-12 col-lg-8 text-center">
                    ...
                    <p class="animated slideInDown text-white" style="font-size: 18px">
            ...
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="h-100">
                        ...
                        <p>
                            Notre plateforme de recrutement spécialisée dans les membres de conseil d'administration  est conçue pour vous
                        ...
                        <p class="mb-4">
                            Confiez-nous la recherche de vos futurs membres de conseil d'administration, 
