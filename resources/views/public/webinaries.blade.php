    ...
    <div class="container-fluid hero-header bg-light py-5 mb-5">
        <div class="container py-5">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6">
                    <h1 class="display-4 mb-3 animated slideInDown">Webinaires</h1>
                ...
                <div class="col-lg-6 animated fadeIn">
                    <img class="img-fluid animated pulse infinite" style="animation-duration: 10s;"
                        src="{{ asset('assets/public/img/webinaires.png') }}" alt="">
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="card-group">
                    @for ($i = 0; $i < 3; $i++)
                        <div class="card hover-scale wow fadeInUp mb-4" data-wow-delay="0.2s">
                            <img src="{{ asset('assets/public/img/webinaires.png') }}" style="width:100%; height:300px; object-fit: cover" class="card-img-top" alt="...">
                            <div class="card-body">
                                ...
                                <p class="card-text text-primary link">
                                    <a href="#">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="1.5" stroke="currentColor" class="text-primary" style="width: 20px">
                    ...
                    @for ($i = 0; $i < 3; $i++)
                        <div class="card hover-scale wow fadeInUp mb-4" data-wow-delay="0.2s">
                            <div class="embed-responsive embed-responsive-item embed-responsive-16by9">
                                <iframe src="https://www.youtube.com/embed/1La4QzGeaaQ" width="100%" height="300px" allowfullscreen></iframe>
                            </div>
                            <div class="card-body">
                                <h5 class="card-title">Présentation de KBS - <span class="fw-bold text-primary"
                                        style="font-size: 16px">24 Juin 2024 11H00</span></h5>
