    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3 class="text-primary">Expériences</h3>
                    ...
                    <div class="card-header p-0 mb-4 w-100 text-right bg-dark">
                        <div class="row p-0 justify-content-between align-items-center">
                            <div class="col-md-5 pl-4 ml-3 py-1 text-left">
                                <h4 class="card-title pt-1 text-white">Liste des expériences professionnelles</h4>
                            </div>
                            <div class="col-md-4 text-right">
                                ...
                                @include('user-space.candidates.modals.add-experience-modal')
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
