            ...
            <form action="#">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Institut de formation" required class="form-control">
                    </div>
                    <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" rows="6" required class="form-control" placeholder="Ajouter une description de la formation"></textarea>
                    </div>
                </div>
