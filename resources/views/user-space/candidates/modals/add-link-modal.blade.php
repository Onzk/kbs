<div class="modal fade text-left" id="addlink" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33"
        ...
        <div class="modal-content">
            ...
            <form wire:submit="saveLink">
                ...
                <div class="modal-footer">
                    <div wire:loading wire:target="saveLink" class="btn" disabled
                        style="pointer-events: none">
                        <div class="spinner-border spinner-border-sm text-primary" role="status"></div>
                    </div>
                    <div wire:loading.remove wire:target="saveLink">
