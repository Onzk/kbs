    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <a href="#" wire:click.prevent="backToSearch" class="text-primary fw-bold h3 pb-2">
                    <span>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" style="width: 20px" fill="currentColor"
                            class="size-6">
                ...
                <p class="text-subtitle text-muted mt-3">
                    Voici les détails professionnels concernant le candidat sélectionné.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="col-12">
        <div class="card h-100 border w-100">
            <div class="card-header m-2 p-2 bg-primary rounded-lg">
                <div class="d-lg-flex justify-content-between justify-content-center align-items-center">
                    <div class="p-2">
                ...
                <div class="row">
                    <div class="col-sm-12 col-lg-3 col-md-12">
                        <div class="form-group">
                            <p class="w-100">
                                <img src="{{ asset($candidate->photo) }}" class="border w-100 rounded-lg"
