<nav class="navbar navbar-header navbar-expand navbar-light">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav d-flex align-items-center navbar-light ml-auto">
            <li class="nav-icon">
                <a href="{{ route('entreprise-space.discussions') }}" class="nav-link mt-2 nav-link-lg nav-link-user">
            ...
            <li class="dropdown mt-2">
                <a href="#" data-toggle="dropdown"
                    ...
                    <div class="avatar mr-2">
                        <img src="{{ asset($_user->photo ?? 'storage/entreprise/default.png')  . "?" . rand() }}"
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    <a class="dropdown-item" href="{{ route('entreprise-space.home') }}"><i data-feather="user"></i>
                        Profil
                    </a>
